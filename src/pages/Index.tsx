...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex flex-col items-center justify-center p-6 text-white">
      ...
      {/* Subtitle */}
      <p className="text-xl text-slate-300 text-center mb-12 max-w-md">
      ...
      <Button 
        ...
        className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-12 py-4 text-lg rounded-full font-medium shadow-lg"
        size="lg"
      >
        Get Started
      </Button>
